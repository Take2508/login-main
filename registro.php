            ...
            <div class="col-8 p-5 bg-white shadow-lg rounded">
                ...
                if (isset($_POST['registro'])) {
                    ...
                    if ($query->rowCount() == 0) {
                        ...
                        if ($result) {
                            echo '<div class="alert alert-success" role="alert"> ¡Tu registro fue exitoso! </div> <a href="new_users.php" class="btn btn-success">OK</a>';
                        } else {
                            echo '<div class="alert alert-danger" role="alert"> ¡Algo salió mal!</div> <a href="new_users.php" class="btn btn-danger">Volver</a>';
                        }
                    }
                }
                ?>
